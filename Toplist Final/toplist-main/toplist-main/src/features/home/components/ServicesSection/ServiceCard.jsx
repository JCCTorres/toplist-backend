...
const ServiceCard = ({ service }) => {
  return (
    <div className="bg-white/10 backdrop-blur-sm rounded-xl shadow-lg p-3 flex flex-col w-[200px] h-[260px] transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:bg-white/20">
