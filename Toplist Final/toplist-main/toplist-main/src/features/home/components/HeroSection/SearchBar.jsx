...
const SearchBar = ({
  ...
  return (
    <div className="rounded-xl shadow-2xl grid grid-cols-2 md:flex md:flex-row gap-2 md:gap-3 p-2 md:p-3 bg-navy-950/80 backdrop-blur-xl border border-white/10">
      ...
      <div className="col-span-2 search-bar-section travel-dates bg-white/10 border border-white/20 text-white py-3 md:py-4 px-4 md:px-6 font-semibold md:flex-[1.5] rounded-lg flex items-center gap-3">
        ...
        <Flatpickr
          ...
          className="w-full bg-transparent outline-none cursor-pointer placeholder-white/40 text-white text-xs md:text-sm leading-tight"
          placeholder="Travel Dates"
        />
      </div>
