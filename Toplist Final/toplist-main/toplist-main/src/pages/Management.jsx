...
function Management() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="font-heading text-3xl font-bold text-center text-white mb-4">Property Management Services</h2>
          <p className="text-sand-200/60 text-center max-w-3xl mx-auto mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {managementServices.map((service, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden card-hover transition-all duration-300">
                <div className="p-8 flex flex-col items-center justify-center">
                  ...
                  <h3 className="font-heading text-white text-lg font-bold uppercase tracking-wider">{service.title}</h3>
                </div>
                <div className="bg-navy-950/50 p-6">
      ...
      <div className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="font-heading text-2xl font-bold mb-6 text-white">Our Management Services</h2>
          <p className="mb-6 text-sand-200/60">We offer comprehensive property management services for vacation homes and rental properties in the Orlando area.</p>
          <ul className="space-y-3">
            {['24/7 Guest Support', 'Property Maintenance', 'Marketing and Booking Management', 'Cleaning and Housekeeping', 'Revenue Optimization'].map((item, i) => (
              <li key={i} className="flex items-center text-sand-200/70">
