...
- SHIPPED **v1.0 MVP** — Phases 1-3 (shipped 2026-02-08) → [Archive](milestones/v1.0-ROADMAP.md)
- **v1.1 Enhancements** — Phase 4+ (in progress)

## Current Milestone: v1.1 Enhancements

### Phase 4: Improve Price Displayed Accuracy

**Goal:** Display accurate total stay prices including cleaning fees, taxes, and estimated Airbnb service fees, so guests have realistic price expectations before redirecting to Airbnb checkout.
**Depends on:** Phase 3
**Plans:** 3 plans
...
<details>
<summary>v1.0 MVP (Phases 1-3) — SHIPPED 2026-02-08</summary>

- [x] Phase 1: API Connection & Data Wiring (2/2 plans) — completed 2026-02-07
- [x] Phase 2: Search, Availability & Booking Flow (2/2 plans) — completed 2026-02-07
- [x] Phase 3: Design Polish & Deployment (2/2 plans) — completed 2026-02-08
